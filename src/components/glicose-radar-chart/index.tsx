...
import radarData from '@/data/radar-chart/glicose_data.json';

const categories = ['Glicemia', 'Hemoglobina Glicada', '120 minutos', 'Basal', 'Glicose Pós Prandial'];

export function GlicoseRadarChart() {
