...
import radarData from '@/data/radar-chart/funcao_renal_data.json';

const categories = ['Uréia', 'Creatinina', 'Potássio', 'pH', 'Cor', 'Proteína', 'Glicose'];

export function FuncaoRenalRadarChart() {
    ...
    <Card className="flex flex-col">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="leading-none text-muted-foreground">
          Comparação dos resultados dos exames de Função Renal
        </div>
      </CardFooter>
    </Card>
  );
