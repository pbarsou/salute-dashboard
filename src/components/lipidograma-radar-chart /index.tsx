...
import radarData from '@/data/radar-chart/lipidograma_data.json';

const categories = ['Colesterol Total', 'Triglicerídeos', 'HDL Colesterol', 'LDL Colesterol'];

export function LipidogramaRadarChart() {
    ...
    <Card className="flex flex-col">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="leading-none text-muted-foreground">
          Comparação dos resultados dos exames de Glicose
        </div>
      </CardFooter>
    </Card>
  );
